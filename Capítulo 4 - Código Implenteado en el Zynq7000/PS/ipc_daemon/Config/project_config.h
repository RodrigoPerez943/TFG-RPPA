...
#define PROJECT_MANUFACTURER		"LECTORVISION"
#define PROJECT_TIME_AND_DATE		20,3,10,0,0,0	/* 2017/01/01; 00:00:00 */
...
#define REGS_IPC_LEN_REG		136u		/* (bytes) */

/** @brief Reserved size for shared memory region */
#define SHM_LEN					((REGS_IPC_NUM_REGS) * (REGS_IPC_LEN_REG))
